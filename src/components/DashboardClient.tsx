    ...
    <div className="min-h-screen bg-zinc-50 text-zinc-900">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          >
            chat<span className="text-zinc-400">ai</span>
          </div>
          <button onClick={() => navigate.push("/embed")} className="px-4 py-2 rounded-lg border border-zinc-300 text-sm hover:bg-zinc-100 transition">
            Embed ChatBot
          </button>
        </div>
      </motion.div>
          ...
          <div className="mb-10">
            ...
            <div className="space-y-4">
              <textarea
                ...
                placeholder="Add information about your business, products, services, policies, FAQs, or anything you want the AI chatbot to know. Example: business hours, refund policy, pricing, or common customer questions."
